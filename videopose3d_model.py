...
# All rights reserved.
#
# Vendored unmodified from facebookresearch/VideoPose3D (common/model.py):
#   https://github.com/facebookresearch/VideoPose3D
# Licensed under CC-BY-NC-4.0 (non-commercial); see that repository's LICENSE.
# Used by pose_lift.py for 2D→3D pose lifting.
#
